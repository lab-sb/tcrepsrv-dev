...
VALUES
(-1,pg_current_wal_lsn(), txid_current(), CURRENT_USER, 'NO_ACTIVITY_LSN_ACK', 'DML', 'UPSERT', NOW()) ON CONFLICT (ddl_id,ddl_origin) DO UPDATE SET wal_lsn=pg_current_wal_lsn(), creation_timestamp=NOW();
#
